...
import 'package:zona0_apk/presentation/widgets/test/BottomNavigationBar/bottom_curved_Painter.dart';
        ...
        child: AnimatedContainer(
          ...
          child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                  color: isEnable ? Theme.of(context).colorScheme.primary : Colors.white,
                  boxShadow: <BoxShadow>[
                    BoxShadow(
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                _icon(Icons.wallet, _selectedIndex == 2, 2),
