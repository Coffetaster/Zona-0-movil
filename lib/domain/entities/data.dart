...
class AppData {
  ...
  static List<Category> categoryList = [
    ...
    Category(
        ...
        image: 'assets/imagen/1.png',
        isSelected: true,
        color: Color.fromARGB(255, 16, 203, 228)),
    Category(
        id: 2,
        name: "Teléfonos",
        image: 'assets/imagen/8.png',
        color: Color.fromARGB(255, 16, 228, 69)),
    Category(id: 3, name: "Ropa", image: 'assets/imagen/3.png', color: Color.fromARGB(255, 228, 16, 200)),
    Category(id: 4, name: "Cámaras", image: 'assets/imagen/6.png', color: Color.fromARGB(255, 16, 30, 228)),
    Category(id: 5, name: "Mochilas", image: 'assets/imagen/4.png', color: Color.fromARGB(255, 16, 228, 157)),
    Category(id: 6, name: "Mandos", image: 'assets/imagen/12.png', color: Color(0xffe46b10)),
  ];
